...
<SettingsDialog title={`Disable ${name}?`} focus="cancel" oncancel={cancel}>
  ...
  {#snippet footer()}
    ...
    <button type="button" class="danger-button" data-dialog-primary disabled={busy} onclick={() => void disable()}>
