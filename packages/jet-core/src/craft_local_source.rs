...
use crate::craft_installation::{
	CraftInstallationConfirmation, CraftInstallationPreview, CraftSource,
	CraftTrust,
};
use crate::craft_publication::ArtifactStaging;
use crate::craft_specification::{
	enabled_features, parse, select_artifact, validate_publisher, version_text,
};
...
pub(crate) async fn preview(
	...
	let specification_bytes = read_bounded_file(
		...
		crate::craft_repository::MAX_SPECIFICATION_BYTES as u64,
	)
	.await?;
